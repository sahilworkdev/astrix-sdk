...
import { TimeDial } from "./components/eventCreation/timeDial";
    ...
    <div style={{ background: "black", minHeight: "100vh" }}>
      <AuthProvider token={import.meta.env.VITE_ASTRIX_APP_AUTH_TOKEN}>
        <ThemeProvider accentColor={import.meta.env.VITE_ACCENT_COLOR}>
         ...
         <Divider title="hello"/>
         <Dropdown options={["Apple", "Banana", "Cherry"]} onSelect={handleSelect} />
         <Calendar onDateChange={()=>{}} selectedDate={new Date()} />
          <TimeDial handleTimeClick={()=>{}} isHourView={true} selectedTime={{ hour: 12, minute: 30 }} />
          <LiveCarousel />
          <PastCarousel />
         </div>
        </ThemeProvider>
