...
const TimeDisplay = ({
    ...
    <div style={{ textAlign: "center", display: "flex", gap: "10px", alignItems: "center", fontFamily: "Mulish, sans-serif", fontWeight: "300" }}>
        <div style={{ fontSize: "1.25rem" }}>
            <button
                type="button"
                onClick={() => handleIsHourChange(true)}
                style={{ color: isHourView ? "#b0e681" : "#E8EAED", border: "none", background: "none", fontSize: "inherit", cursor: "pointer" }}
            >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "5px", fontSize: "1.1rem" }}>
            <button
                style={{ color: selectedTime?.isPM ? "#b0e681" : "#E8EAED", border: "none", background: "none", cursor: "pointer" }}
...
const TimeDial = ({
    ...
    const selectedValue = isHourView
        ? selectedTime.hour === 12
            ? 0
            : selectedTime.hour
        : selectedTime.minute === 60 ? 0 : selectedTime.minute;
    ...
    return (
        <div style={{ width: "256px", height: "256px", backgroundColor: "rgba(33, 33, 33, 0.08)", borderRadius: "50%", position: "relative" }}>
            <svg style={{ position: "absolute", inset: "0", width: "100%", height: "100%", stroke: "#b0e681", fill: "#b0e681" }}>
                ...
                return (
                    <button
                        ...
                        style={{
                            ...
                            background: (isHourView && selectedTime.hour === item) || (!isHourView && selectedTime.minute === item) ? "#b0e681" : "none",
                            color: (isHourView && selectedTime.hour === item) || (!isHourView && selectedTime.minute === item) ? "black" : "#E8EAED",
                            border: "none",
                            cursor: "pointer",
                        }}
                        onClick={() => handleTimeClick(isHourView, isHourView && item === 0 ? 12 : item)}
                    >
